...
def GetEnvironment():
    ...
    opts.Add('program', 'program or interface to compile', 'library, run_methodD, run_methodH, run_methodSH, run_methodR, run_methodSR, run_methodP, run_experiments')
    ...
    if not env['program'] in ['library', 'run_methodD', 'run_methodH', 'run_methodSH', 'run_methodR', 'run_methodSR', 'run_methodP', 'run_experiments']:
