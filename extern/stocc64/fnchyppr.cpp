...
CMultiFishersNCHypergeometric::CMultiFishersNCHypergeometric(int64_t n_, int64_t * m_, double * odds_, int64_t colors_, double accuracy_) {
   // constructor
   int64_t N1;
   int64_t i;
   // copy parameters
...
double CMultiFishersNCHypergeometric::loop(int64_t n, int64_t c) {
